...
<!--    <Button type="primary" class="search" @click="modal=true">创建应用</Button>-->
...
<script>
import ApplicationResultDetail from './components/applicationResultDetail'
import NewApplication from './components/newApplication'
import { QueryApplications, RemoveApplication } from '@/services/application-management'
export default {
    name: 'index.vue',
    components: {
