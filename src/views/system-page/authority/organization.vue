  ...
  <div>
    ...
    <div class="modal-mask" v-if="isNodeEdited">
      ...
      <div class="modal-mask-content">
        ...
        <Form ref="organization" :model="organization" :rules="ruleOrganization" >
          <FormItem prop="orgName" label="机构名称">
            <Input type="text" v-model="organization.orgName" placeholder="机构名称">
              <!-- <Icon type="md-create" slot="prepend"></Icon> -->
            </Input>
          </FormItem>
          <FormItem prop="description" label="机构描述">
            <Input type="text" v-model="organization.description" placeholder="机构描述">
              <!-- <Icon type="md-create" slot="prepend"></Icon> -->
            </Input>
          </FormItem>
          <FormItem prop="groups" label="工作组">
            <Select ref="groupSelect"
              ...
              filterable
            >
              <Option v-for="option in groupOptions" :value="option.value" :key="option.value">
                {{option.label}}</Option>
            </Select>
          </FormItem>
          <FormItem prop="users" label="人员">
            <Select ref="userSelect" v-model="organization.users" multiple filterable>
              <Option v-for="(option, index) in userOptions" :value="option.value" :key="option.value + index">
                {{option.label}}</Option>
            </Select>
          </FormItem>
          <Row type="flex" justify="center">
            <Button type="primary" @click="handleSubmit('organization')" :disabled="isSubmitDisabled">保存</Button>
